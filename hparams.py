...
class Hparams:
    ...
    # model
    parser.add_argument('--lr', default=0.01210, type=float, help="learning rate")
    parser.add_argument('--warmup_rate', default=0.1, type=float, help="learning rate warmup rate")
